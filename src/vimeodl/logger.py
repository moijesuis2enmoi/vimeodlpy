...
vimeodl.logger
==============
Provides a preconfigured logger for the `vimeodl` package.

Functions:
----------
- get_logger(name: str = "vimeodl") -> logging.Logger:
...
def get_logger(name: str = "vimeodl") -> logging.Logger:
    """
    ...
    Args:
        name (str): The name of the logger. Defaults to "vimeodl".
